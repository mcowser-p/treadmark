...
The consumer is the `usc.declarative_access` role (the linux-access repo):
...
def render_access_vars(model: dict) -> str:
    ...
    lines = [
        "---",
        f"# Ansible vars for the usc.declarative_access role — generated by cairn {__version__}",
